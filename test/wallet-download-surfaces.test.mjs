  ...
  try {
    ...
    for (const [locale, localized] of Object.entries(WALLET_DOWNLOAD_COPY)) {
      ...
      for (const [surface, html] of Object.entries({ chooser: localizedChooser, product: localizedProduct })) {
        ...
        for (const key of ["desktop068Boundary", "desktop068Proof", "appImageNotInstalled", "unsignedPreview", "browserPreviewBoundary", "manualExtension", "pwaArchiveOnly", "android26Boundary", "android26Proof", "qaSignedPreview", "desktop068MacSignature", "androidUniversalLabel", "downloadHistory", "githubFallback", "fallbackManual"]) {
