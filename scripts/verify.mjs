...
if (
  ...
  walletSessionRuntime.sourceCommit !== "577f81202a85ff7314dd862f60aa337b0f2fd1f1" ||
  walletSessionRuntime.evidence?.evidenceCommit !== "7c39f78cb8fa398f526c6cd16df45a3f9dd579b6" ||
  ...
  walletSessionRuntime.status?.registryBoundBrowserCorsPassed !== true ||
  ...
  walletSessionRuntime.browserCors?.preflightStatus !== 204 ||
  walletSessionRuntime.browserCors?.preflightZeroMutation !== true ||
  walletSessionRuntime.browserCors?.actualPostRequestIdMatched !== true ||
  walletSessionRuntime.browserCors?.requestIdExposed !== true ||
  walletSessionRuntime.browserCors?.unregisteredOriginAllowHeaderPresent !== false ||
  walletSessionRuntime.browserCors?.wildcardOriginAllowed !== false ||
  walletSessionRuntime.browserCors?.credentialsAllowed !== false
) {
...
if (
  ...
  registryByKey.get("wallet")?.webDownloadManifest?.sha256 !== "871ae6f63048b9d93f7d01951bcfd12d070b4a3ad2a0b05584c650eb0058c2a5" ||
  registryByKey.get("wallet")?.webDownloadManifest?.bytes !== 1844 ||
  registryByKey.get("wallet")?.webDownloadRelease !== "/releases/wallet-web/20260925-wallet-web-testnet-preview-767a05d56.json" ||
  registryByKey.get("wallet")?.webDownloadPreviousRelease !== "/releases/wallet-web/20260920-wallet-web-testnet-preview-c93e16be.json" ||
...
const requiredOfficialDownloads = new Map([
  ...
  ["/downloads/wallet/sha256-929315133c68eda1cabac51cec889c4aeca5e3ee1701578916bc67e096c5dc35/ynx-wallet-desktop-0.1.1-arm64.exe", "https://downloads.ynxweb4.com/wallet/sha256-929315133c68eda1cabac51cec889c4aeca5e3ee1701578916bc67e096c5dc35/ynx-wallet-desktop-0.1.1-arm64.exe"],
...
const invalidDesktopInstallerClaims = [
  ...
  /windows(?:X64|Arm64)?:\s*artifactDownload\([^\n]*\.zip/i
];
...
const walletWindowsArm64ExePublication = JSON.parse(fs.readFileSync("public/releases/wallet-desktop/a8f36e4c5723/windows-arm64-exe-publication.json", "utf8"));
const walletMacReplacement = installerReplacementMatrix.replacements?.find((item) => item.product === "wallet" && item.platform === "macos");
const walletWindowsReplacement = installerReplacementMatrix.replacements?.find((item) => item.product === "wallet" && item.platform === "windows" && item.architecture === "x64");
const walletWindowsArm64Replacement = installerReplacementMatrix.replacements?.find((item) => item.product === "wallet" && item.platform === "windows" && item.architecture === "arm64");
if (
  installerReplacementMatrix.policy?.macos?.join(",") !== ".dmg" ||
  installerReplacementMatrix.policy?.windows?.join(",") !== ".exe,.msix" ||
  installerReplacementMatrix.replacements?.length !== 5 ||
  ...
  walletWindowsArm64Replacement?.publicVerified !== true ||
  walletWindowsArm64Replacement?.originPublicVerified !== true ||
  walletWindowsArm64Replacement?.replacementArtifact !== "ynx-wallet-desktop-0.1.1-arm64.exe" ||
  walletWindowsArm64Replacement?.publicDownloadUrl !== walletWindowsArm64ExePublication.artifact.url ||
  walletWindowsArm64Replacement?.originDownloadUrl !== walletWindowsArm64ExePublication.artifact.originUrl ||
  walletWindowsArm64Replacement?.sha256 !== walletWindowsArm64ExePublication.artifact.sha256 ||
  walletWindowsArm64Replacement?.bytes !== walletWindowsArm64ExePublication.artifact.bytes ||
  installerReplacementMatrix.replacements.filter((item) => ![walletMacReplacement, walletWindowsReplacement, walletWindowsArm64Replacement].includes(item)).some((item) => item.publicVerified !== false || item.replacementArtifact !== null || item.publicDownloadUrl !== null) ||
  ...
  walletWindowsArm64ExePublication.artifact.bytes !== 103487635 ||
  walletWindowsArm64ExePublication.artifact.sha256 !== "929315133c68eda1cabac51cec889c4aeca5e3ee1701578916bc67e096c5dc35" ||
  walletWindowsArm64ExePublication.artifact.fullOriginDownloadRehashed !== true ||
  walletWindowsArm64ExePublication.artifact.fullOfficialWebsiteDownloadRehashed !== true ||
  walletWindowsArm64ExePublication.releaseTruth.officialWebsiteRouteVerified !== true ||
  walletWindowsArm64ExePublication.releaseTruth.productionSigned !== false
) {
