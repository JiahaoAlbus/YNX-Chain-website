...
if (
  ...
  hostedPreviewProducts.map((product) => product.key).sort().join(",") !== "developer,exchange,finance,social,trust,wallet" ||
  ...
  console.error("release registry must preserve 26 truthful states, six source-bound hosted previews, the retired-Shop boundary, and the exact Wallet, Exchange, Finance, Social, Resource, Music, Video, Creator Studio, Cloud and Docs central acceptance set");
  process.exit(1);
}
for (const requiredText of ["downloadHosted", "Local build only", "Download Testnet Preview", "candidate incomplete", "Product status", "wallet-auth-v1.0.0-testnet-preview.5", "exchange-v1.0.0-testnet-preview.3", "shop-v0.3.0-testnet-preview.1", "Android distribution retired", "developer-v0.2.0-testnet-preview.1", "trust-center-v0.1.0-testnet-preview.2"]) {
