...
const approvedOwnerPublicEvidence = new Map([
  ...
  ["11", { sourceCommit: "63a678ac3c423b53c9628fa35c415d554827eccb", publicUrl: "https://developer.ynxweb4.com/" }],
...
if (
  ...
  hostedPreviewProducts.some((product) => {
    const expectedState = product.key === "developer"
      ? "public-testnet-web-with-extension-workspace-and-current-desktop-preview"
...
for (const requiredText of ["downloadHosted", "Local build only", "Download Testnet Preview", "candidate incomplete", "Product status", "wallet-auth-v1.0.0-testnet-preview.5", "exchange-v1.0.0-testnet-preview.3", "shop-v0.3.0-testnet-preview.1", "developer-v0.2.0-testnet-preview.4", "trust-center-v0.1.0-testnet-preview.2"]) {
...
const requiredOfficialDownloads = new Map([
  ["/downloads/ynx-developer-testnet-preview-macos-unsigned.zip", "https://developer.ynxweb4.com/downloads/ynx-developer-0.2.0-testnet-preview-63a678ac-macos-arm64-unsigned.zip"],
  ["/downloads/ynx-developer-testnet-preview-windows-x64-unsigned.zip", "https://developer.ynxweb4.com/downloads/ynx-developer-0.2.0-testnet-preview-63a678ac-windows-x64-unsigned.zip"],
