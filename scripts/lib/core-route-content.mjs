...
const coreRoutes = [
  ["/contact", "Contact YNX Chain", "Join the YNX communities or email the founder directly.", "Let’s build YNX together.", "Connect with our communities on Discord, YouTube, X and GitHub, or email Founder@ynxweb4.com.", [["Email the founder", "mailto:Founder@ynxweb4.com"], ["Join Discord", "https://discord.gg/t8KpAF2KE"], ["Watch YouTube", "https://www.youtube.com/@YNX-Chain"]]],
  ...
  ["/dapp/download", "YNX Ecosystem Downloads", "Find published YNX testnet downloads by platform and review release limitations.", "Choose a download for your device.", "Package availability and installation support vary by platform. Current files and unavailable platforms appear in the download directory.", [["Wallet downloads", "/dapp/wallet/open-download"], ["Installation guide", "/manual"]]],
