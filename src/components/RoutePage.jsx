...
const pages = {
  ...
  "/quant": ["Exchange surface", "Quant Lab remains a candidate interface", "Quant Lab is an Exchange-thread release surface for bounded strategy research and approval workflows. It is not a live trading system, does not control real funds, and has no public deployment or performance claim.", [["Exchange product status", "/exchange"], ["Readiness boundaries", "/readiness"]]],
