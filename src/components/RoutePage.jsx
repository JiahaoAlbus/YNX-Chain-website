...
const pages = {
  ...
  "/support": ["Support", "Use public evidence first", "Check signed Monitor status, canonical Explorer data, documentation, and repository issues. Record the public URL, checked time, source release, affected search or service, and a redacted screenshot. Never send mnemonics, private keys, passwords, internal paths, topology, or custody material to anyone claiming to provide support.", [["Open Network Monitor", apiConfig.monitorUrl], ["Open Explorer", apiConfig.explorerUrl], ["Live chain status", `${apiConfig.apiBase}/status`], ["GitHub issues", "https://github.com/JiahaoAlbus/YNX-Chain/issues"]]],
  ...
  "/dapp/quant": ["Exchange surface", "Quant Lab remains a candidate interface", "Quant Lab is an Exchange product release surface for bounded strategy research and approval workflows. It is not a live trading system, does not control real funds, and has no public deployment or performance claim.", [["Exchange product status", "/dapp/exchange"], ["Readiness boundaries", "/readiness"]]],
	"/status": ["Network status", "Public testnet evidence and limitations", "Use YNX Monitor for the signed, redacted service projection and Chain RPC for canonical height. Compare four-validator, peer, finality and index-lag evidence; endpoint reachability alone does not prove convergence. StreamBFT remains shadow/candidate until an accepted cutover.", [["Open Network Monitor", apiConfig.monitorUrl], ["Live chain status", `${apiConfig.apiBase}/status`], ["Explorer", apiConfig.explorerUrl], ["Readiness boundaries", "/readiness"]]],
