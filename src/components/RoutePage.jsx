...
const pages = {
  "/docs": ["Developer docs", "Build against the live YNX Testnet", "Use the public RPC, EVM JSON-RPC, Explorer, Faucet, JavaScript SDK, Python SDK, and reversible ynx1 address helpers. MetaMask and EVM tooling continue to use the equivalent 0x form.", [["Address converter", "/#address"], ["Chain documentation", "https://github.com/JiahaoAlbus/YNX-Chain/tree/main/docs"], ["JavaScript SDK", "https://github.com/JiahaoAlbus/YNX-Chain/tree/main/sdk/js"], ["Python SDK", "https://github.com/JiahaoAlbus/YNX-Chain/tree/main/sdk/python"]]],
  ...
  "/readiness": ["Readiness", "Current evidence, not future claims", "The authoritative public testnet and ecosystem services are live. Public BFT, independent public-vantage proof, production custody completion, mainnet audit/legal readiness, listings, issuer integrations, and partnerships remain incomplete.", [["Ecosystem package", apiConfig.ecosystemUrl], ["Exchange readiness", apiConfig.exchangeUrl]]],
  ...
  "/trading": ["Readiness", "No exchange listing claim", "YNX Chain and YNXT are not claimed as exchange-listed. Exchange readiness packages require external review and approval before any listing statement is valid.", [["Exchange readiness", apiConfig.exchangeUrl]]],
