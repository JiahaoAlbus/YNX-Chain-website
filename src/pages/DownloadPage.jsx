    ...
    <main className="downloadPage">
      ...
      <section className="downloadGroup" aria-labelledby="available-downloads-title">
        <div className="downloadGroupHeader">
          ...
          <p>{zh ? "这里只列出仍在支持范围内且已登记哈希的 Testnet Preview。YNX Shop Android 已退役，Shop Web/PWA 仍可使用。" : "Only supported, hash-registered Testnet Preview artifacts appear here. YNX Shop for Android is retired; Shop Web/PWA remains available."}</p>
        </div>
