...
const portalLocales = {
  "zh-CN": {
    ...
    "/tokens": { eyebrow: "原生资产", title: "YNXT 清晰可见，仅用于测试网，也能核验。", lead: "YNXT 是 YNX Testnet 原生资产，用于 Gas、手续费和网络资源。没有权威公开来源时，本站不会显示价格、市值或供应量。", facts: ["原生资产：YNXT", "网络：YNX Testnet", "供应量和市场数据：当前没有权威公开接口"], actions: ["在 Explorer 查看 YNXT", "领取 Testnet YNXT"] },
    ...
    "/more": { eyebrow: "项目资源", title: "每一项资源都有明确去向。", lead: "这里汇集白皮书、文档、源码、网络监控和官方社区；离开官网前会明确标识外部目的地。", facts: ["YNX Website：ynxweb4.com", "仅为 Testnet，不宣称 Mainnet。", "请勿向支持人员提供助记词、私钥或密码。"], actions: ["阅读白皮书", "打开 GitHub", "加入 Discord"] }
  }
};
