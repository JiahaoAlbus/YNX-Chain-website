        ...
        <div className="productStatusMain">
          <div className="productStatusSection">
            ...
            <ul className="productEvidenceList">
              ...
              <EvidenceState label="Central acceptance" value={centralAccepted} detail={centralAccepted ? `Commit-bound ${product.release.productRelease?.release || "candidate"} product-release.json is published by this website.` : product.release?.productRelease ? `Owner release evidence ${product.release.productRelease.release || "candidate"} is published; central integration acceptance is still pending.` : "No owner product-release.json was registered during the central audit."} />
