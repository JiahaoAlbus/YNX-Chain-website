      ...
      <section className="docsSessionRelease" id="wallet-session-release" aria-labelledby="wallet-session-release-title">
        <div>
          ...
          <div className="docsSessionReleaseActions">
            ...
            <a className="textLink" href="/releases/wallet-session-router/37f2485ed604/runtime.json">Verify public runtime evidence</a>
        ...
        <dl>
          ...
          <div><dt>Public Product Session v2 Gateway</dt><dd>Deployed · rollback, restart and state integrity verified</dd></div>
