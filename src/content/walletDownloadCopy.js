...
for (const [locale, copy] of Object.entries(WALLET_DOWNLOAD_COPY)) {
 copy.android22Boundary = locale === "zh-CN" ? "1.0.16 测试网预览版，仅本地测试签名，未上架。真实 WalletConnect Relay、真机转账及已安装 Finance 完整流程尚未验证；未配置 Reown Project ID 时配对保持禁用。" : locale === "zh-TW" ? "1.0.16 測試網預覽版，僅本地測試簽名，未上架。真實 WalletConnect Relay、實機轉帳及已安裝 Finance 完整流程尚未驗證；未設定 Reown Project ID 時配對保持停用。" : "1.0.16 Testnet Preview; local-test signed, not store released. Real WalletConnect Relay, physical-device transfers and installed Finance E2E remain unverified. Pairing stays disabled without a Reown Project ID.";
