...
for (const [locale, copy] of Object.entries(WALLET_DOWNLOAD_COPY)) {
 ...
 copy.android25Proof = locale === "zh-CN" ? "发布 APK/AAB 摘要已核对。1.0.19 未重复安装或冷启动验证；1.0.18 实装证据仅为历史记录，真机与 Finance/Relay 未验证。" : locale === "zh-TW" ? "發布 APK/AAB 摘要已核對。1.0.19 未重複安裝或冷啟動驗證；1.0.18 實裝證據僅為歷史紀錄，實機與 Finance/Relay 未驗證。" : "Published APK/AAB digests checked. Install/cold launch not repeated for 1.0.19; 1.0.18 evidence is historical only. Physical devices, Finance and Relay unverified.";
}
