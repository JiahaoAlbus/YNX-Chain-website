...
import { ArrowUpRight, CheckCircle2, Move3d, UsersRound, WalletCards } from "lucide-react";
    ...
    <section className="hero" aria-labelledby="hero-title" style={{ "--hero-scroll": `${scrollOffset}px` }}>
      ...
      <div className="heroInner">
        ...
        <div className="heroActions">
          ...
          <a className="button secondary" href="/community"><UsersRound size={18} /> {zh ? "加入官方社区" : "Join Community"}</a>
