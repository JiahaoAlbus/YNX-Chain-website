...
const evidence = {
  wallet: {
    ...
    downloads: {
      ...
      android: artifactDownload(PRODUCT_STATUS.PREVIEW, "ynx-wallet-1.0.0-testnet-preview-8e8d5644-local-test-signed.apk", "Android Testnet Preview · source 8e8d5644 · SHA-256 43dfe206…24c5 · 78,225,838 bytes · Android API 24+ / target API 36 · full embedded bundle · local test signer only, not production signed or Play Store released.", "/downloads/wallet/sha256-43dfe20665c62f0c963f0d06dc6fca9800d49543b613678a76988879537924c5/ynx-wallet-1.0.0-testnet-preview-8e8d5644-local-test-signed.apk"),
