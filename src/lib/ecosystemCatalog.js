...
const evidence = {
  ...
  developer: {
    ...
    statusNote: "The public YNX Developer Web IDE runs Monaco against chain ID 6423 with pinned Solidity 0.8.24 compilation and YNX-hosted qwen3:4b AI Build. Preview 4 adds a dedicated Extensions workspace: users can inspect editing languages, install/remove declarative language packs, detect real device toolchains, and install/remove reviewed compiler adapters. Custom adapters require separate registration, removal and per-compile approvals, reject shell syntax and built-in overrides, run without network in a bounded project workspace, and report real exits. Editing support is never presented as an installed compiler. Central Wallet acceptance, production signing and store release are not claimed.",
    downloads: {
      ...
      macos: artifactDownload(PRODUCT_STATUS.PREVIEW, "ynx-developer-testnet-preview-macos-unsigned.zip", "Unsigned macOS arm64 Testnet Preview · source 76322af5 · SHA-256 a7254bf0…449b · 177,942,906 bytes · extraction, cold launch, real bounded C++ compile, second launch, cleanup and full public re-download verified.", "/downloads/ynx-developer-testnet-preview-macos-unsigned.zip"),
      windows: artifactDownload(PRODUCT_STATUS.PREVIEW, "ynx-developer-testnet-preview-windows-x64-unsigned.zip", "Unsigned Windows x64 Testnet Preview · source 76322af5 · SHA-256 289a1f48…57c · 72,538,906 bytes · Windows tests, portable extraction, WPF cold launch, public workspace connection, real remote C++ compile, second launch and full public re-download verified.", "/downloads/ynx-developer-testnet-preview-windows-x64-unsigned.zip")
    }
  },
  explorer: {
    commit: "d4b4a3e5d7d6",
