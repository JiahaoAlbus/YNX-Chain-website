...
const evidence = {
  wallet: {
    ...
    statusNote: "Wallet Web, Android, macOS and Windows Testnet Preview artifacts are available from immutable official URLs. The macOS download is a verified universal DMG, not the retired CLI gzip. APK/DMG/EXE are fixed-source release candidates with exact source SHA-256, byte count and signing class published. The DMG is unsigned, not notarized and may be rejected by Gatekeeper; production signing and store release are not claimed.",
    downloads: {
      ...
      macos: artifactDownload(PRODUCT_STATUS.PREVIEW, "ynx-wallet-desktop-0.1.1-universal.dmg", "Universal macOS Testnet Preview DMG · source 6583c3fb83fe · evidence 8183774c0f8b · SHA-256 ad6e4077bc001743cf1a4163ceaca5a009a3c8a4d8a809cc4896798976cf56c0 · 236,661,996 bytes · x86_64 + arm64 · minimum OS metadata macOS 12.0 · install, cold launch, second launch, upgrade, rollback and uninstall verified locally · unsigned and not notarized; Gatekeeper rejected; no production signing or store release claimed.", "https://downloads.ynxweb4.com/wallet/sha256-ad6e4077bc001743cf1a4163ceaca5a009a3c8a4d8a809cc4896798976cf56c0/ynx-wallet-desktop-0.1.1-universal.dmg"),
