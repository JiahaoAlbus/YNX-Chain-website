...
const evidence = {
  wallet: {
    ...
    downloads: {
      ...
      android: artifactDownload(PRODUCT_STATUS.PREVIEW, "ynx-wallet-1.0.1-testnet-preview-c9d53912-local-test-signed.apk", "Android Testnet Preview 1.0.1 · source c9d53912 · SHA-256 ffaf7435…8245 · 78,233,898 bytes · Android API 24+ / target API 36 · API 36 upgrade, cold restart, biometric unlock and real Testnet account read verified · local test signer only, not production signed or Play Store released.", "/downloads/wallet/sha256-ffaf743529ba065c6996da17395c400fd1f0d7869e144a9a2f8d852e07ee8245/ynx-wallet-1.0.1-testnet-preview-c9d53912-local-test-signed.apk"),
