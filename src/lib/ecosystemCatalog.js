...
const evidence = {
  wallet: {
    ...
    downloads: {
      ...
      android: artifactDownload(PRODUCT_STATUS.PREVIEW, "ynx-wallet-1.0.0-testnet-preview-ec0b8295-local-test-signed.apk", "Android Testnet Preview · source ec0b8295 · SHA-256 99360e01…5e0b · 78,226,626 bytes · Android API 24+ / target API 36 · full embedded bundle · retries one safe Testnet read after a transport failure · local test signer only, not production signed or Play Store released.", "/downloads/wallet/sha256-99360e01307a64c7faa3060d72474f2fc3d43031fcb59a69751b836faa465e0b/ynx-wallet-1.0.0-testnet-preview-ec0b8295-local-test-signed.apk"),
