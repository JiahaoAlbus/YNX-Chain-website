...
const evidence = {
  wallet: {
    ...
    statusNote: "The Wallet download selector offers Android 1.0.21 Testnet Preview APK from source 008aa8b07 and the current desktop test previews, and points to the Chrome/Edge 0.1.4 preview from source 13aaa982d while retaining older PWA and Firefox packages. The exact published 1.0.21 APK passed an API 36 emulator code26-to-27 upgrade and retained/unlocked a disposable biometric account. It remains Android Debug test-signed; funded balance, pending outbox recovery, physical-device, Finance and Relay E2E, production signing and store release remain unverified. The 1.0.20 APK/AAB record remains historical. Browser packages remain unsigned manual-install previews; AppImage remains build-only and macOS remains ad-hoc signed and not notarized.",
    downloads: {
