...
const evidence = {
  wallet: {
    ...
    statusNote: "The Wallet download selector keeps the current Android and desktop test previews and now serves deterministic Wallet Web packages rebuilt from source b04765f1. PWA, Chrome/Edge and Firefox public bytes match their immutable SHA-256 paths and passed 354 Wallet Web tests plus package-integrity verification. Browser packages remain unsigned manual-install previews, not store releases or proof of current installed-browser acceptance. AppImage remains build-only; macOS remains ad-hoc signed and not notarized.",
    downloads: {
      ...
      firefox: artifactDownload(PRODUCT_STATUS.PREVIEW, "ynx-wallet-firefox-0.1.1.zip", "Unsigned unpacked Firefox Testnet Preview · source b04765f1 · SHA-256 ed5bdc6c…11f5 · 546,364 bytes · Firefox 142+.", "https://www.ynxweb4.com/downloads/wallet-web/sha256-ed5bdc6c195b1598900a175ff2e294c6529dbca9130ddffde980abdcf29711f5/ynx-wallet-firefox-0.1.1.zip"),
