...
const evidence = {
  wallet: {
    ...
    statusNote: "The Wallet download selector offers Android 1.0.20 Testnet Preview from source f3a12abad and the current desktop test previews, and points to immutable Wallet Web packages from source c93e16be. Android 1.0.20 has published APK/AAB metadata and remains local-test-signed; its installation, PR188 login, funded transfer, physical-device, Finance and Relay E2E are not verified. The earlier Android 1.0.19 API 36 emulator evidence remains historical and does not transfer to 1.0.20. Production signing and store release remain unverified. Browser packages remain unsigned manual-install previews; AppImage remains build-only and macOS remains ad-hoc signed and not notarized.",
    downloads: {
