...
const evidence = {
  wallet: {
    ...
    statusNote: "The Wallet download selector keeps the current Android and desktop test previews and now serves deterministic Wallet Web packages rebuilt from source e76388bf. PWA, Chrome/Edge and Firefox public bytes match their immutable SHA-256 paths and passed 354 Wallet Web tests plus package-integrity verification. Browser packages remain unsigned manual-install previews, not store releases or proof of current installed-browser acceptance. AppImage remains build-only; macOS remains ad-hoc signed and not notarized.",
    downloads: {
      ...
      firefox: artifactDownload(PRODUCT_STATUS.PREVIEW, "ynx-wallet-firefox-0.1.0.zip", "Unsigned unpacked Firefox Testnet Preview · source e76388bf · SHA-256 b30f67a8…81b0 · 546,293 bytes · Firefox 140+.", "https://www.ynxweb4.com/downloads/wallet-web/sha256-b30f67a87e841039f2141065a5857e425838c34ffdb98f3094eedd8abcbb81b0/ynx-wallet-firefox-0.1.0.zip"),
