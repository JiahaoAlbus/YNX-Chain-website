...
const evidence = {
  wallet: {
    ...
    downloads: {
      ...
      android: artifactDownload(PRODUCT_STATUS.PREVIEW, "ynx-wallet-1.0.2-testnet-preview-1f8820c5-local-test-signed.apk", "Android Testnet Preview 1.0.2 · source 1f8820c5 · SHA-256 66a0954f…216a0 · 78,233,842 bytes · Android API 24+ / target API 36 · uses the verified EVM Testnet endpoint; API 36 upgrade, cold restart, biometric unlock and real Testnet account read verified · local test signer only, not production signed or Play Store released.", "/downloads/wallet/sha256-66a0954f7955d800af4b205680ce879c786568cbf6af8a71307cddad31c216a0/ynx-wallet-1.0.2-testnet-preview-1f8820c5-local-test-signed.apk"),
