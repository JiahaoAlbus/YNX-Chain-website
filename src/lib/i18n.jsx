...
const messages = {
  en: {
    ...
    search: "Search", searchOpen: "Search and open command palette", connectWallet: "Connect Wallet", connectingWallet: "Connecting…", walletUnavailable: "No wallet found", walletRequestRejected: "Connection declined", walletConnectionFailed: "Connection failed", light: "Use light mode", dark: "Use dark mode",
  ...
  "zh-CN": {
    ...
    search: "搜索", searchOpen: "搜索并打开命令面板", connectWallet: "连接钱包", connectingWallet: "正在连接…", walletUnavailable: "未检测到钱包", walletRequestRejected: "已拒绝连接", walletConnectionFailed: "连接失败", light: "切换到浅色模式", dark: "切换到深色模式",
  ...
  "zh-TW": {
    skip:"跳至內容",home:"YNX Chain 首頁",primaryNav:"主要導覽",products:"產品",dapps:"DApp",ecosystem:"YNX 生態",download:"下載",manual:"使用手冊",docs:"文件",status:"狀態",explorer:"瀏覽器",openExplorer:"開啟區塊瀏覽器",blockchain:"區塊鏈",tokens:"代幣",data:"資料",governance:"治理",developers:"開發者",downloads:"下載中心",more:"更多",search:"搜尋",searchOpen:"搜尋並開啟命令面板",connectWallet:"連接錢包",connectingWallet:"正在連接…",walletUnavailable:"未偵測到錢包",walletRequestRejected:"已拒絕連接",walletConnectionFailed:"連接失敗",light:"切換至淺色模式",dark:"切換至深色模式",openNav:"開啟導覽",closeNav:"關閉導覽",language:"語言",switchLanguage:"切換語言",footerLead:"以 YNXT 為核心的 Web4 L1 生態系統。",userManual:"使用手冊",developerDocs:"開發者文件",api:"API",faq:"常見問題",security:"安全",support:"支援",square:"廣場",readiness:"就緒度",risk:"風險",privacy:"隱私",terms:"條款",faucet:"水龍頭",footerBoundary:"公開測試網專案；未宣稱主網上線、交易所上幣、錢包預設支援或第三方合作。"
  },
  ja: {
