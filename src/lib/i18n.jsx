...
const messages = {
  en: {
    ...
    products: "Products", dapps: "DApps", download: "Download", manual: "Manual", docs: "Docs", status: "Status", explorer: "Explorer",
  ...
  "zh-CN": {
    ...
    products: "产品", dapps: "DApp", download: "下载", manual: "使用手册", docs: "文档", status: "状态", explorer: "浏览器",
